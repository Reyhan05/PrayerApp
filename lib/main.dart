...
import 'package:jadwal_solat/header_content.dart';
import 'package:jadwal_solat/list_jadwal.dart';
import 'package:jadwal_solat/model/ResponseJadwal.dart';
...
class _MyHomeScreenState extends State<MyHomeSreen> {
  TextEditingController _locationtController = TextEditingController();
  ...
  @override
  void initState() {
    if (_locationtController.text.isEmpty ||
        _locationtController.text == null) {
      _locationtController.text = 'jakarta';
    }
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    final header = Stack(children: <Widget>[
      ...
      FutureBuilder(
          future: getJadwal(
              location: _locationtController.text.toLowerCase().toString()),
